...
def paramModulePhylipMP(dirin, path_phylip_corrected, btp):
  ...
  #Attention: phylipMP not contain consistency for evolutionary models for nucl (ia Modelgenerator)
  ...
  #3.- DNAPARS
  #  Criando arquivo param_phylipDnapars
  arq_param_d = dirin + "/param_phylipDnapars" 
  ...
  #  Executando parametros Dnapars
  print 'Executando Dnapars...\n'
  cmd_d = "phylip dnapars < " + arq_param_d
  handle_d = os.popen(cmd_d, 'r', 1)
  for line_d in handle_d:
    print line_d,
  handle_d.close()

  #  Mudando de nome e diretorio ao outfile do Dnapars
  ...
  print 'Files param_seqboot, param_phylipDnapars and param_phylipMP were created in: ' + dirin + "\n"  

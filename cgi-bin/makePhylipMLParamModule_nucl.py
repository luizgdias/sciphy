...
def paramModulePhylipML(dirin, path_phylip_corrected, btp):
  ...
  #Attention: phylipML not contain consistency for evolutionary models for nucl (ia Modelgenerator)
  ...
  #3.- DNAML
  #  Criando arquivo param_phylipDnaml
  arq_param_d = dirin + "/param_phylipDnaml" 
  ...
  #  Executando parametros Dnaml
  print 'Executando Dnaml...\n'
  cmd_d = "phylip dnaml < " + arq_param_d
  handle_d = os.popen(cmd_d, 'r', 1)
  for line_d in handle_d:
    print line_d,
  handle_d.close()

  #  Mudando de nome e diretorio ao outfile do Dnaml
  ...
  print 'Files param_seqboot, param_phylipDnaml and param_phylipML were created in: ' + dirin + "\n"  

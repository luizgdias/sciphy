...
def ModuleWeighbor(dirin, model, bootstrap, nb_categ):
  ...
  #Weighbor Parameters: Comparing and searching Modelgenerator evolutionary models 
  #Attention: Weighbor and Modelgenerator have different evolutionary models 
  modelWB = {"WAG" : "", "Dayhoff" : "M\n", "JTT" : "M\n\n", "MTREV24" : "M\n\n\n", "BLOSUM62" : "M\n\n\n\n", "VT" : "M\n\n\n\n\n"}
  ...
  for x in modelWB.keys():                                                          #make a slice copy of the entire list
    ...
    if m:
      ...
      import makeWeighborParamModule_aa
      makeWeighborParamModule_aa.paramModuleWeighbor(dirin, path_phylip_corrected, modelHit[1], btp, nbc)
  ...
  if found is False:
    ...
    print "Executing Weighbor using default modelWB - WAG  => modelWB['WAG']\n";
    #usando o modulo paramModule
    import makeWeighborParamModule_aa
    makeWeighborParamModule_aa.paramModuleWeighbor(dirin, path_phylip_corrected, modelWB['WAG'], btp, nbc)

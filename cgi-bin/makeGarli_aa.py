...
# ==============================================================================
# Objetivo do script: Executado do my_script_aa.py | Executa Parametros do Garli para ML
...
def ModuleGarli(dirin, model, bootstrap, nb_categ):
  ...
  mydict_modelGARLInst = {"poisson":"poisson","jones":"jones","dayhoff":"dayhoff","wag":"wag","mtmam":"mtmam","mtrev":"mtrev"}
...
#####  #1.- Garli: Se o modelo MB bate com MG
  ...
  for x in mydict_modelGARLInst.keys():                                                          #make a slice copy of the entire list
    ...
    if m:
      ...
      import makeGarliParamModule_aa
      makeGarliParamModule_aa.paramModuleGarli(dirin, path_nexus_corrected, mydict_modelGARLInst[modelHit[1]], btp, nbc)
  ...
  if found is False:
    ...
    print "Executing paupML using default modelpaupML - JC  => modelGarli['poisson']\n";
    #usando o modulo paramModule
    import makeGarliParamModule_aa
    makeGarliParamModule_aa.paramModuleGarli(dirin, path_nexus_corrected, mydict_modelGARLInst["poisson"], btp, nbc)

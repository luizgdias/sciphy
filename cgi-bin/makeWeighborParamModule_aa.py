...
def paramModuleWeighbor(dirin, path_phylip_corrected, modelWB, bootstrap, nb_categ):
  ...
  # 4.1 Extraindo o comprimento total do alinhamento do arquivo _phy
  ...
  # 4.2 Calculando o invariantAwk (awk, numero de caracteres em cada coluna, tail mostra 2 cifras)
  cmd_iawk = os.system("tail -n +2 " + path_phylip_corrected + " | awk -f /var/www/arpa/cgi-bin/invariant.awk")   # para fedora 5 e Ubuntu
  # Calculando "the number of varying sites" 

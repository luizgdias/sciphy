...
class Set(ProvenanceObject):
    ...
    """
    def __init__(self, tag, type, attributes, transformationTag="", extractors=[], dependency=""):
        ProvenanceObject.__init__(self, tag)
        self.attributes = attributes
        self.type = type
        self.extractors = extractors
        self.transformationTag = transformationTag.lower()
    ...
    def transformationTag(self, transformationTag):
        assert isinstance(transformationTag, str), \
            "The transformation_tag must be a string."
        self._transformationTag = transformationTag
